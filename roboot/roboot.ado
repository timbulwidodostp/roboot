...
program define roboot, eclass sortpreserve
    ...
    capture findfile robreg.ado
    if _rc>0 {
        di as text "ERROR: Package robreg required (install via ssc inst robreg, replace)."            
        exit        
    }    
    if (`seed'==0){
        di ""
    ...
    if (`ncdim'>=1){    
        ...
        if (`ncdim'==2){
            di as text "STEP 2A: First clustering dimension..."
        }
        tempvar clusterid
    ...
    if (`ncdim'==2){        
        ...
        /////////////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////////////
        di as text "STEP 2B: Second clustering dimension..."
        tempvar clusterid
        ...
        /////////////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////////////
        di as text "STEP 2C: Intersection of the two clustering dimensions..."
        tempvar clusterid
...
mata:
    ...
    void _vce_cluster(real scalar B) {
        ...
        pointer(real matrix) rowvector xxp
        pointer(real matrix) rowvector xyp
        pointer(real matrix) rowvector vrp
        xxp = J(1, nc, NULL)
        xyp = J(1, nc, NULL)
        vrp = J(1, nc, NULL)
        for(i=1; i<=nc; i++) {
            xg=panelsubmatrix(X,i,info)
            wg=panelsubmatrix(w,i,info)
            xxp[i] = &(cross(xg,wg,xg))
            yg=panelsubmatrix(y,i,info)
            xyp[i] = &(cross(xg,wg,yg))
            vg=panelsubmatrix(v,i,info)
            rsg=panelsubmatrix(rs,i,info)
            vrp[i] = &(colsum(vg:*rsg))
        }
